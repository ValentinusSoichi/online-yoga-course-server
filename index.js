...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@online-course-yoga.ryd46sj.mongodb.net/?retryWrites=true&w=majority&appName=online-course-yoga`;
...
async function run() {
    try {
        ...
        const database = client.db("online-course-yoga");
